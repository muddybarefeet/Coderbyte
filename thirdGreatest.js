...
var arr = ['this','is','going','to','work','for','me'];

/*sort an array by string length and then return 
the third largest not the third smallest! order numbers biggest to smallest 
and then return the 2nd index!*/

var wordSort = function(strArray) {
